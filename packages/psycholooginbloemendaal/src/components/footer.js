    ...
    <>
      <footer>
        <div className='flex-container-footer'>
          <div className='menus-wrapper'>
            <ul>
              ...
              <li>
                <Link link='/therapie-coaching'>Business</Link>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <Link link='/producties'>Bekijk mijn journalistieke producties</Link>
              </li>
              <li>
        ...
        <p className='info-makers'>
          Deze site is ontworpen door Willemijn van Hardeveld en gebouwd door Ties Hoenderdos
        </p>
      </footer>
